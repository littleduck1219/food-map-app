        ...
        <form
            ...
            onSubmit={handleSubmit(async (data) => {
                try {
                    ...
                    toast.error("맛집수정에 실패하였습니다 다시시도 해주세요.");
                }
            })}>
                ...
                <div className='border-b border-gray-900/10 pb-12'>
                    ...
                    <div className='mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6'>
                        ...
                        <div className='sm:col-span-3'>
                            <label
                                htmlFor='category'
                                className='block text-sm font-medium leading-6 text-gray-900 outline-none ring-inset ring-gray-300 placeholder:text-gray-400'>
                                카테고리
                            </label>
                            <div className='mt-2'>
                                <select
